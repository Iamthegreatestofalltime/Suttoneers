    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-20">
        ...
        <section id="speech" className="space-y-6">
          ...
          <p>We are the Suttoneers and we are here to keep it real with you all. Real people. Real problems. Real solutions. For too long, everyday people, hard workers like us, have been told to settle for less. Less safety in our communities. Less protection for our planet. Less financial security when we’re simply trying to afford groceries, all doing this while struggling to pay off our student loans. We refuse to accept that. Safety in our community is a fundamental right. Whether it’s making sure that our neighborhoods are secure or making sure that laws work for the people and not against. We believe in real action that protects our lives. Our environment matters, too. Climate change isn’t waiting, and neither should we. We are committed to policies that safeguard the air we breathe, the water we drink, and the future we’re building. Living a sustainable lifestyle for us and our future generations is a key responsibility. And let’s not forget about the economy. No one should have to make the impossible choice between feeding their family and paying off the debt that got them their education. The system should work for us, and not against. We need to have sustainable economic policies that actually make sense, ones that will help grow our communities together. The Suttoneers are about solutions that work. No empty promises. No out of touch policies. Just real change that makes a difference in the lives of real people. So, to everyone here today, this campaign is for you, because of you. Let’s stand together, fight for what’s right, and build a future that makes sense. Let’s get to work! Thank you!
</p>
        </section>
      </main>
